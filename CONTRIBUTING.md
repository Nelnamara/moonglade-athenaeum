...
the full walkthrough, and [`docs/architecture.md`](docs/architecture.md) for how the three
main files (`pixai_gallery_backup.py`, `pixai_gallery.py`, `pixai_gui.py`) fit together.
