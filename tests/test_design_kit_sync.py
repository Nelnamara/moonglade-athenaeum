...
def test_every_kit_page_is_stamped_current_and_carries_its_card_marker():
    ...
    # The THREE remaining component harnesses + the two foundation pages. (mg-gallery-picker's,
    # mg-model-picker's and mg-upscale-panel's harnesses were removed with their vanilla elements
    # as those surfaces became the React GalleryPicker/ModelPicker/UpscalePanel, 2026-08-08; any
    # later Claude Design pass is flagged separately.) A kit page announces itself by carrying the
    # markers; this floor stops a rename from quietly dropping one -- and shrinks as the vanilla
    # campaign ports each one.
