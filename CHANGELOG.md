...
## [Unreleased]
- Under the hood: began folding the last loose front-end scripts into the main app build (the art-filters engine is first), and switched The Loom to its real pre-built bundle instead of transpiling itself in the browser — faster to load, and it drops a 3 MB dependency. No visible change.
