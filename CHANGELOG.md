...
- **OFFICIAL and COMMUNITY are the same two colours everywhere now.** On a phone the official contest was marked in lavender and community ones in gold; on the desktop the same two words were coloured the opposite way round. The phone's pairing wins on both, so those words mean one thing wherever you read them. Gold still means the prize, an entry you have made, and a win, on both. (2026-09-05)
