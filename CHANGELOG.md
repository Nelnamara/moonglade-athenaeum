...
- Fixed: the **header logo mark no longer shows a placeholder tile and letter behind it.** When the mark is a real (transparent) logo, the accent-colored square and centered "M" carried over from the original mockup used to peek through around it; the mark image now stands on its own, keeping its slow 3D tilt and sheen. (2026-08-27)
