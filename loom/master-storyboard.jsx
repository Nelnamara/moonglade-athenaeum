...
/* The Loom.dc.html draftStyle/checkBox (2026-08-13 styleset pass): a surface0
   ...
   12px rounded square instead of the browser widget. (The 📱 Mobile view switch
      ...
      <div className="lv-top">
        ...
        {costEstimate.notDoneCount > 0 && (
          <button className="lv-cost-pill" onClick={refreshEstimate} disabled={batching}
            ...
            {/* the DC's bar phrasing (costToFinish, The Loom.dc.html:993): the
                ≈-credits shape reads "… to finish"; free/unpriced shapes keep
                formatCostEstimate's own wording (shared with the Video tab). */}
