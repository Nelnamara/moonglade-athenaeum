    ...
    <div id="gen-mode-edit" style="display:none;">
      ...
      <div id="edit-sub-enhance" style="display:none;">
        ...
        <div class="enh-note" style="margin-top:9px;">
          ...
          cancelled unstarted about an hour later, so this app can't offer them. What does work
          here: <b>Upscale</b> and <b>Hires</b> on the <b>Generate</b> tab's Upscale row (plain
